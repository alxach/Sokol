...
export type AthleteStatus = "Активный" | "Травма" | "Сборы" | "Резерв";
...
export const athletes: Athlete[] = [
  ...
  { id: "SK-0388", name: "Мария Орлова", discipline: "Самбо", rank: "МС", age: 22, city: "Санкт-Петербург", coach: "Иванова Е.С.", status: "Сборы", medals: { gold: 8, silver: 6, bronze: 3 }, rating: 1714, lastEvent: "Кубок мира" },
  ...
  { id: "SK-0533", name: "Ольга Чайка", discipline: "Бокс", rank: "МС", age: 21, city: "Краснодар", coach: "Сидоров П.Н.", groupId: "GRP-003", status: "Сборы", medals: { gold: 7, silver: 4, bronze: 3 }, rating: 1655, lastEvent: "Кубок России" },
...
export type EventStatus = "Предстоящее" | "Прошедшее" | "Отменено";
...
export interface Competition {
  ...
  level: EventLevel;
  participants: number;
  participantsCse: number;
  organizer?: string;
  medals?: { gold: number; silver: number; bronze: number };
}

export const competitions: Competition[] = [
  { id: "EV-001", title: "Кубок России по самбо", discipline: "Самбо", date: "12 июня 2026", city: "Казань", status: "Предстоящее", level: "Федеральный", participants: 120, participantsCse: 14 },
  { id: "EV-002", title: "Первенство ЦФО · дзюдо", discipline: "Дзюдо", date: "24 июня 2026", city: "Тула", status: "Предстоящее", level: "Региональный", participants: 80, participantsCse: 22 },
  { id: "EV-003", title: "Международный турнир ММА", discipline: "ММА", date: "08 июля 2026", city: "Сочи", status: "Предстоящее", level: "Международный", participants: 64, participantsCse: 6 },
  { id: "EV-004", title: "Чемпионат России по боксу", discipline: "Бокс", date: "15 мая 2026", dateEnd: "20 мая 2026", city: "Москва", status: "Прошедшее", level: "Федеральный", participants: 200, participantsCse: 18, medals: { gold: 2, silver: 1, bronze: 3 } },
  { id: "EV-005", title: "Первенство города по дзюдо", discipline: "Дзюдо", date: "27 мая 2026", city: "Ачинск", status: "Прошедшее", level: "Муниципальный", participants: 110, participantsCse: 15, medals: { gold: 3, silver: 2, bronze: 4 } },
  { id: "EV-006", title: "Международный турнир по борьбе", discipline: "Борьба", date: "03 апреля 2026", city: "Красноярск", status: "Прошедшее", level: "Международный", participants: 150, participantsCse: 10, medals: { gold: 1, silver: 2, bronze: 1 } },
  { id: "EV-007", title: "Кубок Красноярского края по самбо", discipline: "Самбо", date: "18 марта 2026", city: "Красноярск", status: "Прошедшее", level: "Региональный", participants: 90, participantsCse: 25, medals: { gold: 4, silver: 3, bronze: 5 } },
  { id: "EV-008", title: "Fight Nights — ММА", discipline: "ММА", date: "28 февраля 2026", city: "Москва", status: "Прошедшее", level: "Федеральный", participants: 48, participantsCse: 8, medals: { gold: 1, silver: 0, bronze: 1 } },
];
...
export const schedules: Schedule[] = [
  { id: "SCH-001", coachId: "2", coachName: "Петров А.В.", group: "Начальная подготовка", discipline: "Дзюдо", dayOfWeek: 1, timeStart: "09:00", timeEnd: "10:30", room: "Зал А" },
  { id: "SCH-002", coachId: "2", coachName: "Петров А.В.", group: "Начальная подготовка", discipline: "Дзюдо", dayOfWeek: 3, timeStart: "09:00", timeEnd: "10:30", room: "Зал А" },
  { id: "SCH-003", coachId: "2", coachName: "Петров А.В.", group: "Начальная подготовка", discipline: "Дзюдо", dayOfWeek: 5, timeStart: "10:00", timeEnd: "11:30", room: "Зал А" },
  { id: "SCH-004", coachId: "2", coachName: "Петров А.В.", group: "УТГ-1", discipline: "Дзюдо", dayOfWeek: 1, timeStart: "15:00", timeEnd: "17:00", room: "Зал Б" },
  { id: "SCH-005", coachId: "2", coachName: "Петров А.В.", group: "УТГ-1", discipline: "Дзюдо", dayOfWeek: 3, timeStart: "15:00", timeEnd: "17:00", room: "Зал Б" },
  { id: "SCH-006", coachId: "2", coachName: "Петров А.В.", group: "УТГ-1", discipline: "Дзюдо", dayOfWeek: 5, timeStart: "15:00", timeEnd: "17:00", room: "Зал Б" },
];
