...
### 5.4 Criteria управления (2026-08-28): сущность `IncentiveCriteria` (на центр), вкладка «Критерии» в `/admin/programs`, дашборд тренера — нормы из API
...
| 5.3 | Дисклеймер | 0.5 |
| 5.4 | Criteria (нормы на центр, утверждение) | 1 |
| **Итого** | | **~13** |
